<?php
    ...
    $config['news'][$nametype]['height'] = 266;
    ...
    $config['news'][$nametype]['css_hinh2'] = '';//background:#000
    ...
    $config['news'][$nametype]['height'] = 266;
    $config['news'][$nametype]['thumb'] = '100x100x1';
    $config['news'][$nametype]['css_hinh'] = '';//background:#000
    $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
    ...
    $config['news']['hinh-thuc-thanh-toan']['notadd'] = '';//khongthemxoa*/
