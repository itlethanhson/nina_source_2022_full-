<?php
    ...
    $config['product'][$nametype]['option'] = false;//thêm các thuộc tính không cần tạo cột
    $config['product'][$nametype]['thuoctinh_gia'] = false; //thêm các thuộc tính - giá cho giỏ hàng
    ...
    $config['product'][$nametype]['check'] = array("noibat" => "Nổi bật", "hienthi" => "Hiển thị");//, "banchay" => "Bán chạy"
    ...
    $config['product'][$nametype]['comment'] = false;
    $config['product'][$nametype]['slug'] = true;
    $config['product'][$nametype]['check'] = array("noibat" => "Nổi bật", "banchay" => "Bán chạy", "hienthi" => "Hiển thị");
    $config['product'][$nametype]['images'] = true;
    $config['product'][$nametype]['show_images'] = true;
    $config['product'][$nametype]['images2'] = false;
    $config['product'][$nametype]['show_images2'] = false;
