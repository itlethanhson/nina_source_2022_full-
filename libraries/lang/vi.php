...
define("taikhoancuaban","Tài khoản của bạn");
define("guibinhluan","Gửi bình luận");
define("sanphamtuongtu","Sản phẩm tương tự");
define("taikhoanthanhvien","Tài khoản thành viên");
define("loaithanhvien","Loại thành viên");
define("khachhangsi","Khách hàng sỉ");
define("khachhangle","Khách hàng lẻ");
define("hangthanhvien","Hạng thành viên");
define("quanlydonhang","Quản lý đơn hàng");
define("danhmuctaikhoan","Danh mục tài khoản");
define("anhdaidiennencokichco","Ảnh đại diện nên có kích cỡ");
define("uploadanh","Upload ảnh");
define("diemtichluy","Điểm tích lũy");
define("timkiemsanpham","Tìm kiếm sản phẩm");
define("baidanhgia","Bài đánh giá");
define("sapxepsanphamtheo","Sắp xếp sản phẩm theo");
define("giagiamdan","Giá giảm dần");
define("giatangdan","Giá tăng dần");
define("giasanpham","Giá sản phẩm");
define("kichco","kích cỡ");
define("loctheo","Lọc theo");
define("phiship","Phí ship");
define("doimatkhau","Đổi mật khẩu");
define("diem","Điểm");
define("giam","Giảm");
define("khimuahang","khi mua hàng");
define("giale","Giá lẻ");
define("giasi","Giá sỉ");
?>