...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
            ...
            <div class="<?=$colRight?>">
                <?php if(isset($config['static'][$type]['images']) && $config['static'][$type]['images'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <div class="delete_1hinh" title="Xóa hình ảnh"><img src="assets/images/delete.png" alt="" data-id="<?=$item['id']?>" data-table="static" data-cot="photo" data-type="<?=$type?>" data-vitrixoa="photoUpload-preview" /></div>
                            <?php
                ...
                <?php if(isset($config['static'][$type]['images2']) && $config['static'][$type]['images2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm" >
                        ...
                        <div class="card-body">
                            <div class="delete_1hinh" title="Xóa hình ảnh"><img src="assets/images/delete.png" alt="" data-id="<?=$item['id']?>" data-table="static" data-cot="photo2" data-type="<?=$type?>" data-vitrixoa="photoUpload-preview2" /></div>
                            <?php
                                $photoDetail2 = ($act != 'copy') ? UPLOAD_NEWS.@$item['photo2'] : '';
                                $dimension2 = "Width: ".$config['static'][$type]['width2']." px - Height: ".$config['static'][$type]['height2']." px (".$config['static'][$type]['img_type'].")";
        ...
        <div class="col-xl-12 card card-primary card-outline text-sm">
            <div class="card-header">
