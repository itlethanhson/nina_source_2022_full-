            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if(isset($config['places']['active']) && $config['places']['active'] == true) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if(isset($is_permission) && $is_permission == true) if($func->checkPermission('places', 'man_city', '', null, 'phrase-1') && $func->checkPermission('places', 'man_district', '', null, 'phrase-1') && $func->checkPermission('places', 'man_ward', '', null, 'phrase-1')  && $func->checkPermission('places', 'man_street', '', null, 'phrase-1')) $none = "d-none";
                        if($com=='places')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if(isset($is_permission) && $is_permission == true) if($func->checkPermission('places', 'man_street', '', null, 'phrase-1')) $none = "d-none";
