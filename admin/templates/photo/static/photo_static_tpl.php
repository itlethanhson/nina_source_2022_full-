                        ...
                        <div class="upload-file">
                            ...
                            <label class="upload-file-label mb-2" for="file">
                                <div class="upload-file-image rounded mb-3">                                   
                                    <img class="rounded img-upload" src="<?=THUMBSnews?>/<?=$config['photo']['photo_static'][$type]['thumb']?>/<?=UPLOAD_PHOTO_L.$item['photo']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo" style="<?=$config['photo']['photo_static'][$type]['css_hinh']?>"/>
                                </div>
                            ...
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <div>   
                                        ...
                                        <audio id="bgmusic" style="top:20px;"  src="<?=$config_base?><?=UPLOAD_PHOTO_L.$item['photo']?>" controls autoplay  style="margin-bottom:20px"/></audio>
                                        </div>                                        
                                    </div>
                                    <strong>
