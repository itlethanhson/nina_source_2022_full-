    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="<?=$colRight?>">
                ...
                <?php if(isset($config['news'][$type]['tailieu']) && $config['news'][$type]['tailieu'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <?php
                                $tailieuDetail = ($act != 'copy') ? UPLOAD_NEWS.@$item['tailieu'] : '';
                                $dimensiontailieu = "Upload file PDF";
                                include TEMPLATE.LAYOUT."tailieu.php";
                            ?>
                        </div>
                    </div>
                <?php } ?>
