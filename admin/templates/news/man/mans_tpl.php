                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) {
                            ...
                            <tr>
                                ...
                                <?php if(isset($config['news'][$type]['show_images']) && $config['news'][$type]['show_images'] == true) { ?>
                                    <td class="align-middle">
                                    	<a href="<?=$linkEdit?><?=$linkID?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['namevi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBSnews?>/<?=$config['news'][$type]['thumb']?>/<?=UPLOAD_NEWS_L.$items[$i]['photo']?>" alt="<?=$items[$i]['namevi']?>" style="<?=$config['news'][$type]['css_hinh']?>"></a>
                                    </td>
                                <?php } ?>
                                <?php if(isset($config['news'][$type]['show_images2']) && $config['news'][$type]['show_images2'] == true) { ?>
                                    <td class="align-middle">
