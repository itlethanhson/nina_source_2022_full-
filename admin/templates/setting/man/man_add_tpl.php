				...
				<div class="row">
					...
					<?php if(isset($config['setting']['hotline']) && $config['setting']['hotline'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control text-sm" name="data[options][hotline]" id="hotline" placeholder="Hotline" value="<?=(!empty($flash->has('hotline'))) ? $flash->get('hotline') : @$options['hotline']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['phone']) && $config['setting']['phone'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="phone">Điện thoại:</label>
							<input type="text" class="form-control text-sm" name="data[options][phone]" id="phone" placeholder="Điện thoại" value="<?=(!empty($flash->has('phone'))) ? $flash->get('phone') : @$options['phone']?>">
						</div>
					<?php } ?>
					...
					<?php if(isset($config['setting']['giohoatdong']) && $config['setting']['giohoatdong'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control text-sm" name="data[options][giohoatdong]" id="giohoatdong" placeholder="Giờ hoạt động" value="<?=(!empty($flash->has('giohoatdong'))) ? $flash->get('giohoatdong') : @$options['giohoatdong']?>">
						</div>
					<?php } ?>
				</div>
