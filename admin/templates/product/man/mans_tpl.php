		                            		...
		                            		<div class="dropdown-menu" aria-labelledby="dropdown-gallery">
		                            			<?php foreach($config['product'][$type]['gallery'] as $key => $value) {
                                                 ...
                                                 ?>
                                                    ...
                                                    <?php /*if($key=='thu-vien-anh'){?>
                                                     <a class="dropdown-item text-dark" href="<?=$linkMulti?>&id_parent=<?=$items[$i]['id']?>&val=thu-vien-anh2" title="<?=$value['title_sub_photo']?>"><i class="far fa-caret-square-right text-secondary mr-2"></i><?=$value['title_sub_photo']?>2</a>
                                                    <?php }*/ ?>
