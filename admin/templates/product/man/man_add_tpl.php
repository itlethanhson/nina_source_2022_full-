        ...
        <div class="row">
        	...
        	<div class="<?=$colRight?>">
        		<?php if(
					...
					<div class="formRow">
						<div class="title_tt">Thuộc tính - giá</div>
						<div class="themthuoctinh">
								<?php if($act=='edit'){
									$ds_thuoctinh = $d->rawQuery("select * from table_product_size_mau where id_product = ? ",array($item['id']));
									?>
								      <?php if(count($ds_thuoctinh)!=0){ ?>       
								            <?php for($i=0;$i<count($ds_thuoctinh);$i++){?>
												<div class="hopsanpham">
													<div class="chi2">
														<input type="text" class="tenmau uploadsp" name="namevi" value="<?=$ds_thuoctinh[$i]['namevi']?>" placeholder="Tên" rel="<?=$ds_thuoctinh[$i]['id']?>" data-table="product_size_mau" data-name="namevi"/>
													</div>
													<div class="chi2">
														<input type="text" class="tenmau uploadsp" name="thuoctinh1" value="<?=$ds_thuoctinh[$i]['thuoctinh1']?>" placeholder="Thuộc tính 1" rel="<?=$ds_thuoctinh[$i]['id']?>" data-table="product_size_mau" data-name="thuoctinh1"/>
													</div>
													<div class="chi2">
														<input type="text" class="tenmau uploadsp" name="thuoctinh2" value="<?=$ds_thuoctinh[$i]['thuoctinh2']?>" placeholder="Thuộc tính 2" rel="<?=$ds_thuoctinh[$i]['id']?>" data-table="product_size_mau" data-name="thuoctinh2"/>
													</div>
													<div class="chi2">
														<input type="text" class="gia uploadsp format-price" name="regular_price" value="<?=$ds_thuoctinh[$i]['regular_price']?>" placeholder="Giá" data-name="regular_price" rel="<?=$ds_thuoctinh[$i]['id']?>" data-table="product_size_mau"/>
													</div>
													<div class="chi2">
														<input type="text" class="gia uploadsp format-price" name="sale_price" value="<?=$ds_thuoctinh[$i]['sale_price']?>" placeholder="Giá khuyến mãi" data-name="sale_price" rel="<?=$ds_thuoctinh[$i]['id']?>" data-table="product_size_mau"/>
													</div>
													<div class="delete_tt"><img src="assets/images/delete.png" alt="" rel="<?=$ds_thuoctinh[$i]['id']?>" data-table="product_size_mau" /></div>
													<div class="clear"></div>
												</div>									
								            <?php } ?>
								      <?php }?>
								...
								<?php } ?>
								<div class="themphantu" idd="addoption">Thêm</div>
							</div>
						</div>
						</div>
						<?php } /*END thuoc tinh - gia */ ?>
