<?php  
	...
	$selectall = " photo, name$lang, slugvi, slugen, sale_price, regular_price, discount, desc$lang, id, type ";//options2
	$sophantrang = 12;
	...
	if($id!='')
	{
		...
		$sql = "select ".$selectall." from #_product where $where order by numb,id desc $limit";
	...
	else
	{
		...
		$where = "type = ? and find_in_set('banchay',status)";
		else
